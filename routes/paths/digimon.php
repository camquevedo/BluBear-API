...
use App\Http\Controllers\Api\V1\Digimons\ViewsDigimonController;
...
Route::group(
    ...
    function () {
        ...
        Route::get('/', [ViewsDigimonController::class, 'index'])
                ->name('digimon.index');
                
        Route::get('/{id}', [DigimonController::class, 'getByParameter']);

        Route::get('/{id}', [ViewsDigimonController::class, 'fetchByParameter'])
                ->name('digimon.fetchByParameter');
